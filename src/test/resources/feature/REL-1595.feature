@ST_4243 @tagtagtag @this_is_story_tag
...
@SC_27991 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_27992 @third_scenario_tag
...
@SC_27993 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_27994 @fifth_scenario_tag
