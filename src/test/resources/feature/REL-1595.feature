@ST_4873 @tagtagtag @this_is_story_tag
...
@SC_31697 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_31698 @third_scenario_tag
...
@SC_31699 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_31700 @fifth_scenario_tag
