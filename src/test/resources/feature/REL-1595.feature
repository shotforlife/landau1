@ST_4192 @tagtagtag @this_is_story_tag
...
@SC_27651 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_27652 @third_scenario_tag
...
@SC_27653 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_27654 @fifth_scenario_tag
