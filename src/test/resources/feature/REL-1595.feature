@ST_5003 @tagtagtag @this_is_story_tag
...
@SC_32639 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_32640 @third_scenario_tag
...
@SC_32641 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_32642 @fifth_scenario_tag
