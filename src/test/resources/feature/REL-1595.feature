@ST_5304 @tagtagtag @this_is_story_tag
...
@SC_34425 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_34426 @third_scenario_tag
...
@SC_34427 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_34428 @fifth_scenario_tag
