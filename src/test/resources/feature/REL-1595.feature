@ST_4480 @tagtagtag @this_is_story_tag
...
@SC_29623 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_29624 @third_scenario_tag
...
@SC_29625 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_29626 @fifth_scenario_tag
