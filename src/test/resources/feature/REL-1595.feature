@ST_5534 @tagtagtag @this_is_story_tag
...
@SC_35154 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_35155 @third_scenario_tag
...
@SC_35156 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_35157 @fifth_scenario_tag
