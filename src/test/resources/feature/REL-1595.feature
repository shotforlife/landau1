@ST_4677 @tagtagtag @this_is_story_tag
...
@SC_30880 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_30881 @third_scenario_tag
...
@SC_30882 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_30883 @fifth_scenario_tag
