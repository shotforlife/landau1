@ST_5117 @tagtagtag @this_is_story_tag
...
@SC_33529 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_33530 @third_scenario_tag
...
@SC_33531 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_33532 @fifth_scenario_tag
