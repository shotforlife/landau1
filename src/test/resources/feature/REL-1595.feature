@ST_5444 @tagtagtag @this_is_story_tag
...
@SC_35034 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_35035 @third_scenario_tag
...
@SC_35036 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_35037 @fifth_scenario_tag
