@ST_4269 @tagtagtag @this_is_story_tag
...
@SC_28136 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_28137 @third_scenario_tag
...
@SC_28138 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_28139 @fifth_scenario_tag
