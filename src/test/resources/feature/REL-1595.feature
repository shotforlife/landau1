@ST_5017 @tagtagtag @this_is_story_tag
...
@SC_32719 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_32720 @third_scenario_tag
...
@SC_32721 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_32722 @fifth_scenario_tag
