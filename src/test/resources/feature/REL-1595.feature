@ST_5010 @tagtagtag @this_is_story_tag
...
@SC_32679 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_32680 @third_scenario_tag
...
@SC_32681 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_32682 @fifth_scenario_tag
