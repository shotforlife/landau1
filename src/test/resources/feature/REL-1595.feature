@ST_4262 @tagtagtag @this_is_story_tag
...
@SC_28096 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_28097 @third_scenario_tag
...
@SC_28098 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_28099 @fifth_scenario_tag
